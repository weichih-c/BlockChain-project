...
//			String randKeyName = rs.nextString() + ".key";
//			this.publicKeyHashAddress = generateNewPublicHashKey(randKeyName);
...
//	}
	...
	private String generateNewPublicHashKey(String pubKeyName) throws NoSuchAlgorithmException, InvalidKeySpecException, IOException{
		String keyStorePath = System.getProperty("user.dir");
		keyStorePath = keyStorePath + "/keystore";
		String pubKeyPath = keyStorePath + File.separator + pubKeyName;
